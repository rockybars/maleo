...
namespace Seed {
	...
	public class Exception {
		...
		public static unowned string get_stack (Seed.Context ctx, Seed.Exception exception);
	...
	public class Value {
		...
		public static bool to_gi_argument (Seed.Context ctx, Seed.Value value, GI.TypeInfo type_info, GI.Transfer transfer, GI.Argument arg, Seed.Value exception);
	...
	[CCode (cheader_filename = "seed.h")]
	public static void importer_add_search_path (Seed.Context ctx, string search_path);
	[CCode (cheader_filename = "seed.h")]
