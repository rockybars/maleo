...
namespace Seed {
	...
	[CCode (cheader_filename = "seed.h")]
	public static unowned Seed.Engine init ([CCode (array_length_name = "argc", array_length_pos = 0.9)] string[]? argv);
	[CCode (cheader_filename = "seed.h")]
	public static unowned Seed.Engine init_with_context ([CCode (array_length_name = "argc", array_length_pos = 0.9)] string[]? argv, Seed.GlobalContext context);
	[CCode (cheader_filename = "seed.h")]
	public static unowned Seed.Engine init_with_context_and_group ([CCode (array_length_name = "argc", array_length_pos = 0.9)] string[]? argv, Seed.GlobalContext context, Seed.ContextGroup group);
	[CCode (cheader_filename = "seed.h")]
	public static unowned Seed.Engine init_with_context_group ([CCode (array_length_name = "argc", array_length_pos = 0.9)] ref unowned string[]? argv, Seed.ContextGroup group);
	[CCode (cheader_filename = "seed.h")]
